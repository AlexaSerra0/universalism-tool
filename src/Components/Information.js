        ...
        <div className="App gradient_background">
            ...
            <div className='Box Text' style={{textAlign: 'left'}}>
                ...
                <div style={{paddingTop: '1rem', textAlign: 'left'}}>
                    This is a prototype tool designed to support the universalism framework, whose goal is to address universalism values during the initial phase of requirements engineering, assisting in the planning of requirements elicitation. The tool provides a document to assist the integration of universalism values in a software project.
                </div>
           </div>
        </div>
    );
